...
def generate_simulated_data(num_samples, defect_probabilities):
  """
...
# Generating our data
start = time.time()
logger.info('Generating data with %d elements', dsize)
np.random.seed(111)

data = generate_simulated_data(num_samples=dsize, defect_probabilities=[0.33,0.34,0.33])
